...
<section class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <!-- Card 6 -->
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 group">
                    <div class="w-14 h-14 bg-linear-to-br from-pink-100 to-red-50 rounded-xl mb-6 flex items-center justify-center group-hover:scale-110 transition duration-500">
                        <i class="fa-solid fa-book text-2xl text-pink-500"></i>  
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Perpustakaan</h3>
                    <p class="text-gray-600 mb-6">Tingkatkan skill dengan webinar dan pelatihan online eksklusif anggota HIMAFI, mulai dari pemrograman, analisis data, hingga soft skills.</p>
                    <a href="/perpustakaan" class="text-pink-500 font-semibold inline-flex items-center hover:text-red-800">
